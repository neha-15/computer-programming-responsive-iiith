window.view = {
    ...
    activateClicks: function() {
        ...
        this.addClickEvent('imageRightangle', function() { view.showRightangleInputs() })
        this.addClickEvent('okRightangle', function() { view.validateRightangleInputs() })
    ...
    showSquareInputs: function() {
        this.hideQuestionBlock('questionRightangle', 'imageRightangle')
    ...
    showRightangleInputs: function() {
        this.hideQuestionBlock('questionSquare', 'imageSquare')
        this.hideQuestionBlock('questionCircle', 'imageCircle')
        this.hideQuestionBlock('questionTriangle', 'imageTriangle')
        this.showQuestionBlock('questionRightangle', 'imageRightangle')
        this.hideInstructions()
        this.unCheckRadioButtons()
    },
    ...
    approveRightangleInputs: function() {
        this.displayFunctionForRightangle()
        this.showInstructions()
        document.getElementById('questionRightangle').className = 'questionBlock hide'
        document.getElementById('imageRightangle').className += ' disabledImage'
        document.getElementById('tickRightangle').className = 'tick'
        document.getElementById('imageRightangle').style.opacity = '0.3'
        this.i++
            this.replaceDivs()
    },
    ...
    validateRightangleInputs: function() {
        var options1, options2, options3, options4
        var a, b, c, d
    ...
    displayFunctionForRightangle: function() {
        document.getElementById('functionRightangle').innerHTML += 'float area_right (float a,float b)<br>{<br> &emsp; float area = 1/2*a*b;<br> &emsp; return area;<br>}'
    },
    ...
    area_right: function(param, functionCall) {
    ...
    resetToInitialState: function() {
        ...
        document.getElementById('imageRightangle').className = 'imageRightangle'
        ...
        document.getElementById('tickRightangle').className = 'tick hide'
        ...
        document.getElementById('functionRightangle').innerHTML = ''
    ...
    calculateArea: function() {
        ...
        for (i = 0; i < elements.length; i++) {
            ...
            } else if (parameter.length === 2 && functionCall === 'area_right()' && isNaN(parameter[0]) === false && isNaN(parameter[1]) === false)
