document.getElementById('btnRandom').addEventListener('change', (randomCheckbox) => {
        document.getElementById('userInput').disabled = randomCheckbox.target.checked
    }),

    document.getElementById("btnManual")
    .addEventListener("change", (manualCheckbox) => {
        document.getElementById("userInput").disabled = !manualCheckbox.target.checked
    }),
    window.view = {
        numbers: new Array(),
        ...
        /* disableText: function(userInput) {
             document.getElementById(userInput).disabled = true
         },
         enableText: function(userInput) {
        ...
        takeInputFromRadioBox: function() {
            var element = document.getElementById('btnRandom')
